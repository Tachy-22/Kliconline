    ...
    <footer className="bg-[#161722] text-gray-300 py-10 h-full flex z-30 relative">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="-4 text-sm">Visit our website: <a href="http://www.kliconline.org" className="hover:text-orange-500">www.kliconline.org</a></p>
        ...
        <div className="flex gap-8 ">
          ...
          <div className="flex flex-col h-full gap-4">
            ...
            <div className="flex items-center gap-4 -4">
              <Link href="https://facebook.com/Kliconline" className="hover:text-orange-500">
                <svg
              ...
              <Link href="https://twitter.com/Kliconline" className="hover:text-orange-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <Link href="https://instagram.com/Kliconline" className="hover:text-orange-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
                  fill="currentColor"
              ...
              <Link href="https://youtube.com/KLICECHURCH" className="hover:text-orange-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5"
                  fill="currentColor"
            ...
            <div className="mt-4 text-sm">
              <p>Audio Livestream: <a href="https://mixlr.com/kliconline" className="hover:text-orange-500">mixlr.com/kliconline</a></p>
              <p>Video Livestream: <a href="https://youtube.com/KLICECHURCH" className="hover:text-orange-500">KLICECHURCH - YouTube</a></p>
            </div>
          </div>
        </div>
        {/* Subscribe Section */}

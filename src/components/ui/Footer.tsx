        ...
        <div>
          ...
          <div className="flex items-center border border-orange-100/80 !rounded-xl  overflow-hidden  h-[3rem]">
            <input
              ...
              className="w-full py-2 px-4  h-full bg-transparent  focus:outline-none text-black"
            />
            <Button className="bg-[#FFD2A4] text-[#161722] py-2 px-4  hover:bg-[#FFD2A4]/90 min-h-full h-ful ">
              Subscribe
            </Button>
          </div>
        </div>

...
const OurBlogs = ({ blogs }: { blogs: BlogT[] }) => {
  // const blogs = [
  //   {
  //     category: "Faith",
  ...
  return (
    <section className="py-[6rem]  flex flex-col gap-12">
      <div className="text-center flex flex-col gap-3 b">
        <p className="text-lg uppercase text-gray-600">Read Our Blog</p>
        <h2 className="text-3xl font-bold">Share, Inspire, Innovate</h2>
      </div>
      <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full md:max-w-7xl mx-auto p-3 lg:px-4">

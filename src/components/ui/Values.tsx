...
const Values = () => {
  ...
  return (
    <section className="py-8 lg:py-12 pb-16  bg-white text-center max-w-full md:max-w-[80rem] mx-auto lg:px-[4.5rem] p-3 flex flex-col gap-2 overflow-hidden">
      {/* Sub-Headline */}
      ...
      {/* Image Grid */}
      <div className="   ">
        <div className="mt-10 h-full flex min-h-[30rem] overflow-x-auto max-w-[87vw] lg:max-w-full mx-auto lg:grid  lg:grid-cols-3 lg:gap-6   gap-2">

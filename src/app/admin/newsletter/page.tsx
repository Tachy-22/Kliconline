...
import { NewsletterHistoryTable } from "@/components/tables/NewsletterHistoryTable";
...
export default async function NewsletterPage() {
  ...
  const newslettersResult = await fetchCollection<NewsletterHistoryT>("newsletters");
  
  const subscribers = "items" in subscribersResult ? subscribersResult.items : [];
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-3 space-y-12">
      ...
      <section>
        ...
        <p className="mb-6 text-gray-600">Compose and send newsletters to your subscriber list</p>
        <NewsletterForm subscribers={subscribers} />
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4">Newsletter History</h2>
        <p className="mb-6 text-gray-600">View past newsletters and their performance metrics</p>
        <NewsletterHistoryTable newsletters={newsletters} />
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4">Subscriber List</h2>
        <p className="mb-6 text-gray-600">Manage your newsletter subscribers and their preferences</p>
